...
- [## §3 · Workflow: DoorDash Product Development](./references/3-workflow-doordash-product-development.md)
- [## §4 · Engineering Systems](./references/4-engineering-systems.md)
- [## §5 · Examples](./references/5-examples.md)
- [## §6 · Progressive Disclosure Navigation](./references/6-progressive-disclosure-navigation.md)
- [## §7 · Best Practices Library](./references/7-best-practices-library.md)
- [## §8 · Risk Framework](./references/8-risk-framework.md)
- [## §9 · Integration & References](./references/9-integration-references.md)
...
Input: Handle standard doordash request with standard procedures
...
| **Done** | All steps complete |
| **Fail** | Steps incomplete |
Input: Manage complex doordash scenario with multiple stakeholders
