...
Input: Design and implement a huawei engineer solution for a production system
...
### Example 2: Edge Case
Input: Optimize existing huawei engineer implementation to improve performance by 40%
