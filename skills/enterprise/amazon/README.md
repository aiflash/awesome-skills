...
- [## §2 · Amazon Company Context](./references/2-amazon-company-context.md)
- [## §3 · The 16 Leadership Principles](./references/3-the-16-leadership-principles.md)
- [## §4 · Working Methodologies](./references/4-working-methodologies.md)
- [## §5 · Technical Architecture Patterns](./references/5-technical-architecture-patterns.md)
- [## §6 · Detailed Examples](./references/6-detailed-examples.md)
...
Input: Handle standard amazon request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex amazon scenario with multiple stakeholders
