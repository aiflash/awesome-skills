...
- [## §2 · Airbnb Identity](./references/2-airbnb-identity.md)
- [## §3 · Domain Knowledge](./references/3-domain-knowledge.md)
- [## §4 · Workflow: Airbnb Product Development](./references/4-workflow-airbnb-product-development.md)
- [## §5 · Examples](./references/5-examples.md)
- [## §6 · References](./references/6-references.md)
- [## §7 · Quick Reference](./references/7-quick-reference.md)
...
Input: Handle standard airbnb request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex airbnb scenario with multiple stakeholders
