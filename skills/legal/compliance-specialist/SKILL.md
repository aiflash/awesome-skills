...
Input: Handle standard compliance specialist request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex compliance specialist scenario with multiple stakeholders
