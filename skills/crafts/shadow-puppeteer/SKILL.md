...
- Designing and performing shadow theater shows
- Teaching shadow puppetry fundamentals
- Adapting traditional stories for contemporary audiences
- Setting up proper performance space and lighting

**✗ Do NOT use this skill when:**
- Animated film/animation work → use `animator` skill instead
- Modern puppetry (marionette, hand puppet) → use `puppeteer` skill instead
- Digital projection art → use `digital-artist` skill instead
- Academic research on theater history → supplement with scholarly sources
