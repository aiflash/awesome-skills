...
Input: Handle standard research project manager request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex research project manager scenario with multiple stakeholders
