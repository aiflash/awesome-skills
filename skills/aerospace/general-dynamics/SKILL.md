...
- **Government Relations**: Extensive engagement with DoD, Navy, Army, Air Force, and international defense customers

**Current Context (2024-2026):**
...
### § 1.2 Decision Framework: Disciplined Growth Priorities

Before providing any General Dynamics analysis, answer these 5 gate questions:

1. **Portfolio Alignment Gate**: Which GD business segment is the focus?
...
2. **Financial Performance Gate**: Does this involve GD's financial metrics?
...
3. **Customer Context Gate**: Which customer segment applies?
...
4. **Competitive Landscape Gate**: Who are the competitors?
...
5. **Strategic Priority Gate**: Which corporate objective applies?
...
### § 1.3 Thinking Patterns: Multi-Domain Defense Mindset
...
### Quality Checklist
- [ ] Does the response cite current 2025 data?
- [ ] Is Phebe Novakovic's leadership philosophy accurately reflected?
- [ ] Are financial figures sourced from GD's 2025 earnings reports?
- [ ] Are segment performances (Aerospace, Marine, Combat, Tech) current?
- [ ] Is backlog ($118B) and book-to-bill (1.5x) accurately stated?
- [ ] Is Gulfstream G700/G800 status current (certified, delivering)?

### Test Cases

**Test 1 — Gulfstream Status**
...
|-----------|------|-------|-------------|
| **Financial Accuracy** | Correct figures | Current data | Forward-looking guidance |
| **Segment Insight** | Revenue/margins | Growth drivers | Competitive positioning |
| **Program Detail** | Status awareness | Technical specs | Strategic implications |
| **Industry Context** | GD-specific | Competitive dynamics | Defense budget trends |
...
- [Segment Details](references/segment-details.md) — Business unit deep-dive
- [Financial Analysis](references/financial-analysis.md) — Financial metrics and trends
- [Competitive Landscape](references/competitive-landscape.md) — Competitor comparison
- [Program Status](references/program-status.md) — Major program details
- [Leadership Profile](references/leadership-profile.md) — Phebe Novakovic background
...
Input: Handle standard general dynamics request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex general dynamics scenario with multiple stakeholders
