...
tags:
  - domain: biotech
  - subtype: regulatory-affairs-specialist
  - level: expert
...
Input: Handle standard regulatory affairs specialist request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex regulatory affairs specialist scenario with multiple stakeholders
