...
Input: Handle standard bioinformatics scientist request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex bioinformatics scientist scenario with multiple stakeholders
