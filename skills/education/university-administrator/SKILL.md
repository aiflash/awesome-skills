...
tags:
  - domain: education
  - subtype: university-administrator
  - level: expert
...
Input: Handle standard university administrator request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex university administrator scenario with multiple stakeholders
