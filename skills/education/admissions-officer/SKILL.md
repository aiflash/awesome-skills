...
Input: Handle standard admissions officer request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex admissions officer scenario with multiple stakeholders
