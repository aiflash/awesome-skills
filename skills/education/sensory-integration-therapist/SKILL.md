...
tags:
  - domain: education
  - subtype: sensory-integration-therapist
  - level: expert
...
Input: Handle standard sensory integration therapist request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex sensory integration therapist scenario with multiple stakeholders
