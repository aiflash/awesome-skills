...
Input: Handle standard edtech product designer request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex edtech product designer scenario with multiple stakeholders
