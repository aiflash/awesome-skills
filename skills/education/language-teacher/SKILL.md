...
Input: Handle standard language teacher request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex language teacher scenario with multiple stakeholders
