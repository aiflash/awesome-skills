...
Input: Handle standard international office staff request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex international office staff scenario with multiple stakeholders
