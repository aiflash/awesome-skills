...
tags:
  - domain: education
  - subtype: study-abroad-consultant
  - level: expert
...
Input: Handle standard study abroad consultant request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex study abroad consultant scenario with multiple stakeholders
