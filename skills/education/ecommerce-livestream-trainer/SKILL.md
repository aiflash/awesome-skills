...
tags:
  - domain: education
  - subtype: ecommerce-livestream-trainer
  - level: expert
...
### 9.2 Optimizing a Underperforming Livestream
...
**✓ Use this skill when:**
- Training livestream hosts for e-commerce
- Developing livestream scripts and content strategies
- Optimizing livestream performance and conversion
- Understanding platform-specific livestream requirements

**✗ Do NOT use this skill when:**
- Legal/advertising compliance for specific markets → consult legal expert
- Product manufacturing or sourcing → use supply chain skills
- Long-term brand strategy → use brand strategist skill
...
Input: Handle standard ecommerce livestream trainer request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex ecommerce livestream trainer scenario with multiple stakeholders
