...
Input: Handle standard academic counselor request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex academic counselor scenario with multiple stakeholders
