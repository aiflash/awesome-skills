...
Input: Handle standard independent consultant request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex independent consultant scenario with multiple stakeholders
