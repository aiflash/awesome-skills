...
Input: Handle standard executive assistant request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex executive assistant scenario with multiple stakeholders
