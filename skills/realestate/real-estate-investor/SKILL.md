...
Input: Handle standard real estate investor request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex real estate investor scenario with multiple stakeholders
