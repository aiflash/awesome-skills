...
Input: Handle standard urban planner request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex urban planner scenario with multiple stakeholders
