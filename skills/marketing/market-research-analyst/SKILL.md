...
Input: Handle standard market research analyst request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex market research analyst scenario with multiple stakeholders
