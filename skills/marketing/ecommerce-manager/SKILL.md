...
Input: Handle standard ecommerce manager request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex ecommerce manager scenario with multiple stakeholders
