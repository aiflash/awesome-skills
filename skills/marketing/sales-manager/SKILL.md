...
Input: Handle standard sales manager request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex sales manager scenario with multiple stakeholders
