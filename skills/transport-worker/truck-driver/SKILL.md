...
**Self-Score:** 9.5/10 — EXEMPLARY — Comprehensive truck driver framework with HOS compliance, load securement, and professional scenarios.
...
Input: Handle standard truck driver request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex truck driver scenario with multiple stakeholders
