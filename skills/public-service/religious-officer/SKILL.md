...
Input: Handle standard religious officer request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex religious officer scenario with multiple stakeholders
