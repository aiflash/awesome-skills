...
Input: Handle standard strategy consultant request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex strategy consultant scenario with multiple stakeholders
