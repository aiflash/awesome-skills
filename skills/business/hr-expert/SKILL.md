...
- [## § 4 · Core HR Frameworks](./references/4-core-hr-frameworks.md)
- [## § 6 · Platform Installation](./references/6-platform-installation.md)
- [## § 7 · Common Pitfalls](./references/7-common-pitfalls.md)
...
Input: Handle standard hr expert request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex hr expert scenario with multiple stakeholders
