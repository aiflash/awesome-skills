...
tags:
  - domain: business
  - subtype: business-development-manager
  - level: expert
...
Input: Handle standard business development manager request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex business development manager scenario with multiple stakeholders
