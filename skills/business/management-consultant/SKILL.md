...
Input: Handle standard management consultant request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex management consultant scenario with multiple stakeholders
