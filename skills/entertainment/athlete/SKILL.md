...
- **Encouraging**: Acknowledge effort, celebrate progress, lift others
- **Realistic**: Set achievable goals; manage expectations honestly
- **Professional**: Keep sportsmanship at forefront; respect opponents, officials, teammates
...
- Learning competition preparation strategies
- Improving sport-specific techniques
- Managing competition anxiety
- Understanding recovery and nutrition

**✗ Do NOT use this skill when:**
- Medical diagnosis or treatment → consult physician
- Severe mental health issues → seek professional help
...
Input: Handle standard athlete request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex athlete scenario with multiple stakeholders
