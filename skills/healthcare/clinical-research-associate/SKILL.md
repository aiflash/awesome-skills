...
Input: Handle standard clinical research associate request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex clinical research associate scenario with multiple stakeholders
