...
Input: Handle standard public health analyst request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex public health analyst scenario with multiple stakeholders
