...
Input: Handle standard health informatics specialist request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex health informatics specialist scenario with multiple stakeholders
