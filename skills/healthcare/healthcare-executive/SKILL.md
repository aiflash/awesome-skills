...
Input: Handle standard healthcare executive request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex healthcare executive scenario with multiple stakeholders
