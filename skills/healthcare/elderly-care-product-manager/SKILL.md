...
Input: Handle standard elderly care product manager request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex elderly care product manager scenario with multiple stakeholders
