...
tags:
  - domain: healthcare
  - subtype: clinical-trial-manager
  - level: expert
...
Input: Handle standard clinical trial manager request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex clinical trial manager scenario with multiple stakeholders
