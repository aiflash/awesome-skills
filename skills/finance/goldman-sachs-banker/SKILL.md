...
Input: Handle standard goldman sachs banker request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex goldman sachs banker scenario with multiple stakeholders
