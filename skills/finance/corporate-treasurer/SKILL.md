...
Input: Handle standard corporate treasurer request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex corporate treasurer scenario with multiple stakeholders
