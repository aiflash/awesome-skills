...
Input: Handle standard housekeeping trainer request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex housekeeping trainer scenario with multiple stakeholders
