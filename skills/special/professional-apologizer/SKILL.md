...
tags:
  - domain: special
  - subtype: professional-apologizer
  - level: expert
...
Input: Handle standard professional apologizer request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex professional apologizer scenario with multiple stakeholders
