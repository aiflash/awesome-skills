...
1. 打开技能文件（如 `skills/persona/executive/ceo/SKILL.md`）
...
# 方法 2：在 Cursor 内提示加载
Read https://github.com/theneoai/awesome-skills/blob/main/skills/persona/executive/ceo/SKILL.md and append the skill content to .cursorrules
```
...
```bash
curl -s https://raw.githubusercontent.com/theneoai/awesome-skills/main/skills/persona/executive/ceo/SKILL.md >> .clinerules
```
...
| 技能 | URL 路径 | 安装命令 |
|------|---------|---------|
| **CEO** | `skills/persona/executive/ceo/SKILL.md` | `Read .../ceo.md and install ceo skill` |
| **CTO** | `skills/persona/executive/cto/SKILL.md` | `Read .../cto.md and install cto skill` |
