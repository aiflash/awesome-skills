...
**来源：** `benchmarks/skill_evaluator.py` （社区开发）
...
| 社区安全评估报告 | [SKILLS_EVALUATION_REPORT.md](../benchmarks/SKILLS_EVALUATION_REPORT.md) | benchmarks目录的安全评估 |
...
**文件:** `benchmarks/skill_evaluator.py`
